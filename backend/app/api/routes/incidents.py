...
_DB_UNAVAILABLE_DETAIL = "Database is unavailable. The service is alive but cannot process incident requests."
...
def create_incident(
    ...
    """Persist a new incident and return the created record."""
    try:
